...
if __name__ == "__main__":
    ...
    scene1_trees = [
        ...
        {
            "tree": tree_gen.generate(1000, SKYLINE, 90, np.pi / 2, np.pi / 4, 10),
            "start_color": (0, 0, 255),
            "end_color": (255, 255, 0),
            "gradient": "reverse"
        },
    ...
    scenes = [
        {"day": True,  "sun": True,  "moon": False, "text": "Sunny Day",        "file": "scene_day_sun.png"},
        {"day": False, "sun": False, "moon": True,  "text": "Starry Night",     "file": "scene_night_moon.png"},
